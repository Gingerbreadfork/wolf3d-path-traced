...
//
// Path-traced renderer hook: extract the live game state (camera, walls,
// doors, pushwalls, actors, statics, lights) and render the world. The
// following present composites classic + path traced according to the mode.
//
    RENDER_Frame3D();
